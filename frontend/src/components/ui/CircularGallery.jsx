...
class App {
  ...
  createMedias(items, bend = 1, textColor, borderRadius, font) {
    const defaultItems = [
      { image: detail1, text: "Luxury Villa" },
      { image: detail2, text: "Modern Apartment" },
      { image: detail3, text: "Beachfront Property" },
      { image: detail4, text: "Mountain Retreat" },
      { image: detail5, text: "City Penthouse" },
      { image: detail6, text: "Country Estate" },
      { image: detail7, text: "Garden Villa" },
      { image: detail8, text: "Waterfront Home" },
      { image: detail9, text: "Historic Mansion" },
      { image: detail10, text: "Contemporary House" },
      { image: detail11, text: "Luxury Condo" },
      { image: detail12, text: "Rural Farmhouse" },
      { image: detail13, text: "Urban Loft" },
      { image: detail14, text: "Seaside Cottage" },
      { image: detail15, text: "Mountain Cabin" },
      { image: detail16, text: "Condominium" },
      { image: detail17, text: "Premium Apartments" },
      { image: detail18, text: "Mansions" },
      { image: detail19, text: "Beautiful Decor" },
      { image: detail20, text: "Sea Side View" },
    ];
